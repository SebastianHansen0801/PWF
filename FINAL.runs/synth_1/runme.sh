...
HD_PWD='/zhome/5f/5/155462/MCU project/FINAL/FINAL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MCU_TOP.tcl
