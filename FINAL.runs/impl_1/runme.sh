...
HD_PWD='/zhome/5f/5/155462/MCU project/FINAL/FINAL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MCU_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MCU_TOP.tcl -notrace
